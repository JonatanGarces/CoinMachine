    ...
    public class PrintQueueMonitor
    {
        ...
        public void PrinterNotifyWaitCallback(Object state, bool timedOut)
        {
            try
            {
                ...
                #endregion read notification details
                ...
                #endregion populate Notification Information
                ...
                #endregion iterate through all elements in the data array
                ...
                #endregion reset the Event and wait for the next event
            }
            catch (Exception exception)
            {
